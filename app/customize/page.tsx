...
export default function Customize() {
  ...
  const [totalPrice, setTotalPrice] = useState<number>(69200) // Base price set to 69200
  ...
  const generatePDF = () => {
    ...
    doc.text(`₹${(69200).toLocaleString()}`, 180, yPos, { align: "right" })
    yPos += 5
    doc.text("Total Additional Cost:", 20, yPos)
    const additionalCost = totalPrice - 69200
