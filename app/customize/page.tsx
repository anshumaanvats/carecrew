...
const options: Options = {
  controlOptions: [
    ...
    { label: "Gesture Control", price: 1500, selected: false, disabled: false },
  ...
  mobilityComfort: [
    ...
    { label: "Auto Height Adjustment", price: 2000, selected: false, disabled: false },
    { label: "Posture Correction System", price: 1500, selected: false, disabled: false },
    { label: "Ventilated Seat with Temperature Adjustment", price: 3000, selected: false, disabled: false },
  ],
  securitySafety: [
    { label: "Biometric Authentication Lock", price: 0, selected: true, disabled: true },
    { label: "Emergency Panic Button", price: 1000, selected: false, disabled: false },
  ...
  chargingPower: [
    ...
    { label: "Solar Charging", price: 2500, selected: false, disabled: false },
    { label: "Wireless Charging Dock", price: 5000, selected: false, disabled: false },
  ],
  smartHomeIntegration: [
    { label: "Basic Home Control (Lights & Fans)", price: 0, selected: true, disabled: true },
    { label: "IoT-Based Smart Home Control", price: 2500, selected: false, disabled: false },
    { label: "Voice Assistant", price: 9000, selected: false, disabled: false },
  ],
  extraAddons: [
    { label: "Led Headlights and Horn", price: 0, selected: true, disabled: true },
    { label: "Foot Rest Support", price: 1200, selected: false, disabled: false },
    { label: "Head Rest Support", price: 800, selected: false, disabled: false },  
    { label: "Battery Upgrade (More capacity)", price: 4000, selected: false, disabled: false },
